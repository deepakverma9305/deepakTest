...
public class CreateDeal_Amber_MarkAsUnsuccessfulChecker extends GUITest {
	...
	public void runTests(GuiTestReportSuite gt) {
		...
		try{
			...
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Bid/Tender Bond"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Payment Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Performance Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Advance Payment Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Labour Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Shipping Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Maintenance Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Customs Bond"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Retention Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Immigration Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Security Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Financial Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Trade Licence Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Avalisation"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Court Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Lease Guarantee (villa IRS)"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Rental Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Credit Facilities"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Study Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Preference Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Retainage Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
			gt.addTest(lt.logonBasic("john","john"));
			gt.addTest(amberEscalationMarkAsUnsuccesfulChecker("Local Outward BGI","Issue","Airline Agent Guarantee"));
			gt.addTest(lt.logoutBasic());
			resetEnv(gt);
	...
	public GuiTestReportSingleTest amberEscalationMarkAsUnsuccesfulChecker(String productType, String step, String productSubType) throws InterruptedException{
		setActiveTest(new GuiTestReportSingleTest());
		getActiveTest().setTestDescription("Create a deal and Release - Gold Case(" + productType+":" + productSubType +":" + step +" - CreateDeal_Amber_MarkAsUnsuccessfulChecker())");
		...
		try{
			...
			ts= new TestStep();
			ts.setStepName("Validate the item exists in the queue.");
			activeStep = ts;
			
			if ( waitForExistance(landingPage.getPageObjectByID("LandingPage.Claim").getBy())){
				ts.setPassed(true);
				...
				ts.setPassed(false);
				ts.setTestStepImage(takeScreenshot(driver));
				ts.setOptionalFailureMessage("No item was found in the follow up task queue.");
				getActiveTest().addTestStep(ts,driver);
			}
			
			if ( !getActiveTest().hasPassed()){
				//Test has failed, at follow up, dont proceed.
			...
			activeStep = ts;
			driver.findElement(dealRelease.getPageObjectByID("DealRelease.MarkAsUnsuccessfulButton").getBy()).click();
			ts.setPassed(true);
			getActiveTest().addTestStep(ts,driver);
			
			ts= new TestStep();
			ts.setStepName("Click on the 'New' queue");
			activeStep = ts;
			driver.findElement(landingPage.getPageObjectByID("LandingPage.NewQueue").getBy()).click();
			ts.setPassed(true);
			getActiveTest().addTestStep(ts,driver);
			...
			ts= new TestStep();
			ts.setStepName("Click on the 'Unsuccessful' queue");
			activeStep = ts;
			...
			ts= new TestStep();
			ts.setStepName("Validate the item exists in the Unsuccessful Queue");
			activeStep = ts;
			if ( waitForExistance(landingPage.getPageObjectByID("LandingPage.ViewDetailButton").getBy())){
				...
				ts.setPassed(false);
				ts.setTestStepImage(takeScreenshot(driver));
				ts.setOptionalFailureMessage("No task was allocated to the unsuccessful queue.");
				getActiveTest().addTestStep(ts,driver);
			}
			...
			at = getActiveTest();
			at.addTestSteps(new LogonTests(this.controller, getMap(), sl, driver, webDriver).logoutBasic());
			at.addTestSteps(new LogonTests(this.controller, getMap(), sl, driver, webDriver).logonBasic("john", "john"));
			setActiveTest(at);
			try{
				Thread.sleep(1500);
			}catch(Exception e){
			...
			ts= new TestStep();
			ts.setStepName("Click on the 'Follow Up' queue.");
			activeStep = ts;
			driver.findElement(landingPage.getPageObjectByID("LandingPage.FollowUpQueue").getBy()).click();
			ts.setPassed(true);
			getActiveTest().addTestStep(ts,driver);
			...
			ts= new TestStep();
			ts.setStepName("Validate there is nothing to claim in the 'Follow Up' queue.");
			activeStep = ts;
			try{
				driver.findElement(landingPage.getPageObjectByID("LandingPage.Claim").getBy()).isDisplayed();
				ts.setPassed(false);
				ts.setTestStepImage(takeScreenshot(driver));
				ts.setOptionalFailureMessage("The MAKER follow up task was not removed from the MAKERS follow up queue after the CHECKER marked as unsuccessful");
				getActiveTest().addTestStep(ts,driver);
			}catch (Exception e){
				ts.setPassed(true);
				ts.setTestStepImage(takeScreenshot(driver));
				ts.setOptionalFailureMessage("The Follow up task in the MAKER queue was correctly removed.");
				getActiveTest().addTestStep(ts,driver);
			}
