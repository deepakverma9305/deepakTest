...
public class CreateDeal_SanctionsAndCredit extends GUITest {

	private GuiTestReportSuite gt;

	public CreateDeal_SanctionsAndCredit(GUIController controller) {
		super(controller);
	...
	public void runTests(GuiTestReportSuite gt) {
		...
		try{
			...
			gt.addTest(aa.sanctionsLegalAndCreditEscalations("Export LC","Issue","Export LC"));
